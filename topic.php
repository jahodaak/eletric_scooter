...
// Funkce pro kontrolu, zda má uživatel profilový obrázek
function maProfilovyObrazek($userId)
{
    return file_exists("profile_pics/$userId.jpg");
}

// Mazání místností nebo příspěvků
...
<body>
    <div class="container">
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="POST" action="admin_nastroje.php" style="display:inline;">
                                ...
                                <input type="text" name="novy_nickname" placeholder="Nová přezdívka" required>
                                <button type="submit" name="prejmenovat_uzivatele">Přejmenovat</button>
                            </form>
                            <a class="link-button" href="admin_nastroje.php?smazat_id=<?php echo $uzivatel['id']; ?>&typ_smazani=uzivatel">Smazat</a>
                            <a class="link-button" href="profil.php?id=<?php echo $uzivatel['id']; ?>">Přejít na profil</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
        ...
        <div class="section">
            <h2>Seznam chatovacích místností</h2>
            <table>
                <thead>
                    <tr>
                        <th>ID</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="link-button" href="chat_room.php?id=<?php echo $mistnost['id']; ?>">Přejít do místnosti</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="link-button" href="topic.php?id=<?php echo $prispevek['id']; ?>">Přejít na příspěvek</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
